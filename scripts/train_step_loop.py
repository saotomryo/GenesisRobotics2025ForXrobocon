...
def train_step_loop(total_timesteps=100000, chunk_size=10000, base_model_path=None, robot_type='tristar', save_name=None):
    """
    段差乗り越え訓練ループ
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='段差乗り越え訓練ループ')
